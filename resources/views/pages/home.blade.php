...
@section('title', 'amrizal.me — System Analyst & Builder')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row items-center gap-10 md:gap-16">
            <div class="flex-1 text-center md:text-left">
                <p class="text-sm font-medium text-primary-600 mb-3 tracking-wide uppercase">System Analyst & Builder</p>
                <h1 class="text-4xl md:text-6xl font-extrabold text-neutral-900 dark:text-white leading-tight text-balance">
                    Halo, saya <span class="text-primary-600">Amrizal</span>
                </h1>
...
<section class="py-16 md:py-24 bg-neutral-50 dark:bg-neutral-900 border-y border-neutral-200 dark:border-neutral-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-end justify-between mb-10">
            <div>
                <h2 class="text-3xl md:text-4xl font-bold text-neutral-900 dark:text-white">Proyek Unggulan</h2>
                <p class="mt-2 text-neutral-600 dark:text-neutral-300">Beberapa karya terbaru yang pernah dikerjakan.</p>
            </div>
...
<section class="py-16 md:py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-end justify-between mb-10">
            <div>
                <h2 class="text-3xl md:text-4xl font-bold text-neutral-900 dark:text-white">Artikel Terbaru</h2>
                <p class="mt-2 text-neutral-600 dark:text-neutral-300">Tulisan seputar teknologi, sistem, dan pengembangan.</p>
            </div>
...
<section class="py-16 md:py-24 bg-gradient-to-br from-primary-950 via-primary-900 to-primary-600">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="mt-4 text-lg text-white/80 text-balance">Saya terbuka untuk diskusi seputar analisis sistem, perancangan arsitektur, atau pengembangan produk digital — dengan atau tanpa AI tools.</p>
        <div class="mt-8 flex flex-wrap justify-center gap-3">
            <a href="/contact" class="inline-flex items-center px-6 py-3 rounded-md text-sm font-semibold text-primary-900 bg-white hover:bg-neutral-100 shadow-sm transition-all">Hubungi Saya</a>
            <a href="/about" class="inline-flex items-center px-6 py-3 rounded-md text-sm font-semibold text-white border border-white/30 hover:bg-white/10 transition-all">Pelajari Lebih Lanjut</a>
        </div>
    </div>
</section>
