    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-16">
            ...
            <div class="lg:col-span-2 space-y-6">
                <div>
                    <h2 class="text-xl font-semibold text-neutral-900 dark:text-white mb-4" data-i18n="contact.contact_info_title">{{ __('public.contact.contact_info_title') }}</h2>
                    <div class="space-y-4">
                        @if ($settings['email'])
                            <a href="mailto:{{ $settings['email'] }}" class="card-animate flex items-start gap-4 p-4 rounded-lg border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900 hover:border-primary-600/30 hover:bg-primary-600/5 transition-all group" data-delay="1">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-neutral-900 dark:text-white" data-i18n="contact.email">{{ __('public.contact.email') }}</p>
                        ...
                        @if ($settings['whatsapp'])
                            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings['whatsapp']) }}" target="_blank" rel="noopener noreferrer" class="card-animate flex items-start gap-4 p-4 rounded-lg border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900 hover:border-primary-600/30 hover:bg-primary-600/5 transition-all group" data-delay="2">
                                <div class="w-10 h-10 rounded-lg bg-primary-600/10 flex items-center justify-center shrink-0">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-neutral-900 dark:text-white" data-i18n="contact.whatsapp">{{ __('public.contact.whatsapp') }}</p>
                        ...
                        @endif
                        @if ($settings['github'])
                            <a href="https://github.com/{{ $settings['github'] }}" target="_blank" rel="noopener noreferrer" class="card-animate flex items-start gap-4 p-4 rounded-lg border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900 hover:border-primary-600/30 hover:bg-primary-600/5 transition-all group" data-delay="3">
                                <div class="w-10 h-10 rounded-lg bg-primary-600/10 flex items-center justify-center shrink-0">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-neutral-900 dark:text-white" data-i18n="contact.github">{{ __('public.contact.github') }}</p>
                        ...
                        @if ($settings['linkedin'])
                            <a href="https://linkedin.com/in/{{ $settings['linkedin'] }}" target="_blank" rel="noopener noreferrer" class="card-animate flex items-start gap-4 p-4 rounded-lg border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900 hover:border-primary-600/30 hover:bg-primary-600/5 transition-all group" data-delay="4">
                                <div class="w-10 h-10 rounded-lg bg-primary-600/10 flex items-center justify-center shrink-0">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-neutral-900 dark:text-white" data-i18n="contact.linkedin">{{ __('public.contact.linkedin') }}</p>
                        ...
                        @if ($settings['location'])
                            <div class="card-animate flex items-start gap-4 p-4 rounded-lg border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900" data-delay="5">
                                <div class="w-10 h-10 rounded-lg bg-primary-600/10 flex items-center justify-center shrink-0">
                                    <svg class="w-5 h-5 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                                </div>
                                <div>
                                    <p class="text-sm font-medium text-neutral-900 dark:text-white" data-i18n="contact.location">{{ __('public.contact.location') }}</p>
            ...
            <div class="lg:col-span-3">
                <div class="card-animate bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 p-6 md:p-8" data-delay="2">
                    <h2 class="text-xl font-semibold text-neutral-900 dark:text-white mb-6" data-i18n="contact.form_title">{{ __('public.contact.form_title') }}</h2>
                    ...
                    <form action="{{ route('contact.store') }}" method="POST" class="space-y-5">
                        ...
                        <div class="flex items-center justify-between gap-4">
                            <p class="text-xs text-neutral-500 dark:text-neutral-400" data-i18n="contact.reply_time">{{ __('public.contact.reply_time') }}</p>
                            <button type="submit" class="inline-flex items-center px-6 py-2.5 rounded-md text-sm font-semibold text-white bg-primary-600 hover:bg-primary-900 shadow-sm hover:shadow-md transition-all" data-i18n="contact.send">
