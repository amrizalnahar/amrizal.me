        ...
        <div class="max-w-3xl space-y-6">
            ...
            @empty
                <div class="card-animate bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 p-6 flex flex-col sm:flex-row gap-4" data-delay="1">
                    ...
                    <div class="flex-1">
                        <h3 class="text-lg font-semibold text-neutral-900 dark:text-white">System Analyst</h3>
                        <p class="text-base font-medium text-primary-600">PT. Digital Nusantara</p>
                        <p class="text-sm text-neutral-500 dark:text-neutral-400 mt-1">Mei 2023 — Sekarang · 3 tahun</p>
        ...
        <div class="max-w-3xl space-y-6">
            ...
            @empty
                <div class="card-animate bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 p-6 flex flex-col sm:flex-row gap-4" data-delay="1">
                    ...
                    <div class="flex-1">
                        <h3 class="text-lg font-semibold text-neutral-900 dark:text-white">Institut Teknologi Telkom Purwokerto (ITTP)</h3>
                        <p class="text-base font-medium text-neutral-700 dark:text-neutral-200">Sistem Informasi — S1</p>
                        <p class="text-sm text-neutral-500 dark:text-neutral-400 mt-1">2018 — 2022</p>
                    </div>
                </div>
            @endforelse
        </div>
            ...
            @empty
                <div class="card-animate bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 p-6" data-delay="1">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <span class="px-2.5 py-1 rounded-md text-xs font-medium bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-300 border border-neutral-200 dark:border-neutral-700">Flowchart/Swimlane</span>
                        ...
                        <span class="px-2.5 py-1 rounded-md text-xs font-medium bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-300 border border-neutral-200 dark:border-neutral-700">Wireframing (Balsamiq)</span>
                    </div>
                </div>
                <div class="card-animate bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 p-6" data-delay="2">
                ...
                <div class="card-animate bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 p-6" data-delay="3">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <span class="px-2.5 py-1 rounded-md text-xs font-medium bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-300 border border-neutral-200 dark:border-neutral-700">Kimi</span>
                        ...
                        <span class="px-2.5 py-1 rounded-md text-xs font-medium bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-300 border border-neutral-200 dark:border-neutral-700">Gemini</span>
