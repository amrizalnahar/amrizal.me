...
<div class="min-h-screen flex items-center justify-center pt-16 my-16">
  <div class="max-w-lg mx-auto px-4 sm:px-6 text-center">
    ...
    <div class="relative mx-auto w-40 h-40 sm:w-48 sm:h-48 mb-8">
      <div class="absolute inset-0 rounded-full bg-gradient-to-br from-primary-600/10 to-primary-400/10"></div>
      ...
      <!-- Decorative dots -->
      <div class="absolute top-2 right-4 w-3 h-3 rounded-full bg-primary-400/40"></div>
      <div class="absolute bottom-4 left-2 w-2 h-2 rounded-full bg-primary-600/30"></div>
      <div class="absolute top-1/2 -right-2 w-2 h-2 rounded-full bg-primary-400/20"></div>
    </div>
