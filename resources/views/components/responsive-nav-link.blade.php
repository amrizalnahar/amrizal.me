...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-primary-600 text-start text-base font-medium text-primary-600 bg-primary-50 focus:outline-none focus:text-primary-700 focus:bg-primary-100 focus:border-primary-900 transition duration-150 ease-in-out'
