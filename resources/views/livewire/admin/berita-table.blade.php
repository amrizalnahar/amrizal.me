                ...
                <tbody class="divide-y divide-neutral-100">
                    @forelse ($this->posts as $post)
                        <tr class="hover:bg-neutral-50 transition-colors">
                            ...
                            <td class="px-4 py-3">
                                @if($post->thumbnail)
                                    <img src="{{ asset('storage/' . $post->thumbnail) }}" alt="" class="w-10 h-10 rounded-lg object-cover">
                                @else
                            ...
                            <td class="px-4 py-3">
                                <div class="font-medium text-neutral-800">{{ Str::limit($post->localize('title'), 50) }}</div>
