<div>
    <div class="max-w-4xl mx-auto">
        <div class="flex items-center gap-3 mb-6">
            <a href="{{ route('admin.certificates') }}" class="text-neutral-500 hover:text-neutral-700">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
            </a>
            <h1 class="text-xl font-bold text-neutral-800">{{ $certificate ? 'Edit Sertifikat' : 'Tambah Sertifikat' }}</h1>
        </div>
        ...
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <textarea id="description_id" wire:model="description_id" rows="4" class="mt-1 block w-full border-neutral-300 focus:border-primary-600 focus:ring-primary-600 rounded-md shadow-sm text-sm" placeholder="Masukkan deskripsi sertifikat dalam Bahasa Indonesia"></textarea>
                    ...
                    <div>
                        ...
                        <textarea id="description_en" wire:model="description_en" rows="4" class="mt-1 block w-full border-neutral-300 focus:border-primary-600 focus:ring-primary-600 rounded-md shadow-sm text-sm" placeholder="Enter certificate description in English (optional)"></textarea>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
                ...
                <div class="flex items-start gap-4">
                    @if($issuer_logo)
                        <div class="relative">
                            <img src="{{ $issuer_logo->temporaryUrl() }}" class="w-32 h-32 rounded-lg object-cover border border-neutral-200">
                    ...
                    <div class="flex-1">
                        ...
                        <div wire:loading.class.remove="hidden" wire:target="issuer_logo" class="hidden mt-2 text-sm text-primary-600">Mengunggah...</div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
                ...
                <div class="flex items-start gap-4">
                    @if($certificate_image)
                        <div class="relative">
                            <img src="{{ $certificate_image->temporaryUrl() }}" class="w-32 h-32 rounded-lg object-cover border border-neutral-200">
                    ...
                    <div class="flex-1">
                        ...
                        <div wire:loading.class.remove="hidden" wire:target="certificate_image" class="hidden mt-2 text-sm text-primary-600">Mengunggah...</div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" id="issued_at" wire:model="issued_at" class="mt-1 block w-full border-neutral-300 focus:border-primary-600 focus:ring-primary-600 rounded-md shadow-sm text-sm" />
                    ...
                    <div>
                        ...
                        <input type="date" id="expired_at" wire:model="expired_at" class="mt-1 block w-full border-neutral-300 focus:border-primary-600 focus:ring-primary-600 rounded-md shadow-sm text-sm" />
                        <p class="mt-1 text-xs text-neutral-400">Kosongkan jika sertifikat tidak memiliki tanggal kedaluwarsa.</p>
            ...
            <div class="flex justify-end gap-3">
                <a href="{{ route('admin.certificates') }}" class="px-4 py-2 bg-neutral-100 text-neutral-700 text-sm font-medium rounded-lg hover:bg-neutral-200 transition-colors">Batal</a>
                <x-primary-button type="submit" wire:loading.attr="disabled" wire:target="save,issuer_logo,certificate_image">{{ $certificate ? 'Simpan Perubahan' : 'Tambah Sertifikat' }}</x-primary-button>
            </div>
        </form>
    </div>
</div>
