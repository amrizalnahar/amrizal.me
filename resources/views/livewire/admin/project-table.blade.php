                        ...
                        <tr class="hover:bg-neutral-50 transition-colors">
                            <td class="px-4 py-3">
                                @if($project->thumbnail)
                                    <img src="{{ Storage::url($project->thumbnail) }}" alt="{{ $project->title_id }}" class="w-10 h-10 rounded-lg object-cover">
                                @else
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <a href="{{ route('admin.projects.show', $project) }}"
                                        class="p-1.5 text-neutral-500 hover:text-primary-600 hover:bg-primary-50 rounded-md transition-colors" title="View">
