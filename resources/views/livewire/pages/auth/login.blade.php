...
<div class="text-center">
    {{-- Header --}}
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-neutral-800">Selamat Datang Kembali</h2>
    ...
    <form x-data="{
        ...
        <div class="flex items-center justify-between mt-4">
            <label for="remember" class="inline-flex items-center">
                <input wire:model="form.remember" id="remember" type="checkbox" class="rounded border-neutral-300 text-primary-600 shadow-sm focus:ring-primary-600" name="remember">
                <span class="ms-2 text-sm text-neutral-600">Ingat saya</span>
            </label>

            @if (Route::has('password.request'))
                <a class="text-sm text-primary-600 hover:underline font-medium" href="{{ route('password.request') }}" wire:navigate>
                    Lupa password?
                </a>
            @endif
        </div>
