...
<div class="text-center">
    ...
    <div class="mb-6">
        ...
        <p class="mt-2 text-sm text-neutral-600">
            ...
            @elseif($statusType === 'error')
                {{ $statusMessage }}
            @else
                Masukkan password baru yang kuat untuk akun <span class="font-medium text-neutral-800">{{ $email }}</span>.
            @endif
        </p>
    </div>
    ...
    @else
        ...
        @if($statusType === 'error')
            <div class="mb-6">
                <a href="{{ route('password.request') }}" wire:navigate class="text-sm text-primary-600 hover:underline font-medium">
        ...
        <form x-data="{
            ...
            <div class="text-left">
                ...
                <x-text-input wire:model="email" id="email" class="block mt-1 w-full bg-neutral-100" type="text" name="email" readonly autofocus autocomplete="username" />
            ...
            <div class="mt-4 text-left">
                ...
                <div class="relative mt-1" x-data="{ show: false }">
                    <input x-model="plainPassword"
                           id="password"
                           class="block w-full pr-10 rounded-md border-neutral-300 shadow-sm focus:border-primary-600 focus:ring-primary-600"
